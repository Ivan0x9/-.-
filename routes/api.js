...
router.post('/submittran', function(req,res){
    var sql = [
        "INSERT INTO transakcije SET",
        " banka=?",
        ",racun=?",
        ",partner=?",
        ",adresa=?",
    ...
    var inserts = ["","",req.body.partner,"","",req.body.iznos,req.body.opis,req.body.datum,req.body.id_rac];
